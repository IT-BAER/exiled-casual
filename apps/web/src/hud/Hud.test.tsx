...
function makeSnap(overrides: {
  ...
  return {
    ...
    player: {
      ...
      stats: { armour: 0, armourPct: 0, fireResPct: 0, manaRegenPerSec: 6, spellDamagePct: 0 },
    },
...
describe("Hud", () => {
  ...
  it("renders boss bar and phase indicator when a boss entity is present", () => {
    const snap: Snapshot = {
      ...
      atlasSeed: 0,
      completedNodes: [],
      player: { id: 0, x: 0, y: 0, life: 100, maxLife: 100, mana: 30, maxMana: 60, cooldowns: {}, alive: true, casting: false, flasks: { lifeCharges: 7, lifeMax: 7, manaCharges: 7, manaMax: 7 }, stats: { armour: 0, armourPct: 0, fireResPct: 0, manaRegenPerSec: 6, spellDamagePct: 0 } },
