...
function makeSnap(entityOverrides: Partial<Snapshot["entities"][number]>[] = []): Snapshot {
  return {
    ...
    atlasSeed: 0,
    completedNodes: [],
    player: { id: 0, x: 0, y: 0, life: 100, maxLife: 100, mana: 60, maxMana: 60, cooldowns: {}, alive: true, casting: false, flasks: { lifeCharges: 7, lifeMax: 7, manaCharges: 7, manaMax: 7 }, stats: { armour: 0, armourPct: 0, res: { fire: 0, cold: 0, lightning: 0, chaos: 0 }, manaRegenPerSec: 6, spellDamagePct: 0 } },
