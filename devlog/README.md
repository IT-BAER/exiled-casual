...
<td width="33%"><img src="screenshots/2026-07-27-rarity-tinted-gear.jpeg" alt="The same armoured character three times: green as worn normal, gold-washed as rare, warm copper as unique" width="100%"><br><sub><b>The tier you can see across the room</b> - one authored armour set and no second pack to cut another from, so rarity recolours it instead: rare washes gold, unique copper, in the frame colours the tooltip already uses. Albedo could not do it (a gold factor over a green texture moved the render 3%), so the tint is emissive, kept low because the glow layer turns anything higher into a lamp.</sub></td>
</tr>
</table>
